...
public class StringType extends AbstractType {
    ...
    public StringType(SpecVersion specVersion, String name, Map<String, SchemaProperty> properties) {
        ...
        return (specVersion, name, value, propertyFactory) -> {
            ...
            for (Map.Entry<String, Object> object : value.entrySet()) {
                properties.put(object.getKey(),
                        propertyFactory.createProperty(SchemaPropertyContext.Type.STRING, object.getKey(),
                                object.getValue()));
            }
            return new StringType(specVersion, name, properties);
        };
    }
    ...
    public void format(Serializer serializer, Object rawValue) throws IOException {
        if (rawValue != null) {
            ...
            serializer.writePropertyValue(String.valueOf(rawValue));
