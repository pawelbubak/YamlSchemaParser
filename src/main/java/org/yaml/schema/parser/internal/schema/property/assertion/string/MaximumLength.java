...
@SchemaPropertyName("maximumLength")
@SchemaVersion(SpecVersion.DRAFT_01)
public class MaximumLength extends AbstractNumberAssertion {

    public MaximumLength(BigDecimal value) throws SchemaPropertyNotExistsInSpecificationException {
        this(SpecVersion.current(), value);
    }

    public MaximumLength(SpecVersion specVersion, BigDecimal value)
            throws SchemaPropertyNotExistsInSpecificationException {
        super(specVersion, value);
    }

    public static SchemaPropertyMapper<Number> mapper() {
        return (specVersion, value, propertyFactory) -> new MaximumLength(specVersion, mapToBigDecimal(value));
    }
    ...
    protected AbstractMessage.Key getProblemMessageCode() {
        return ValidationMessage.Key.MAXIMUM_LENGTH_VALIDATION_PROBLEM;
    }
