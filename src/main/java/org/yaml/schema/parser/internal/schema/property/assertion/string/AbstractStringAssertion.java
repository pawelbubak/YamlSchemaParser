...
public abstract class AbstractStringAssertion<T> extends AbstractSchemaSimpleProperty<T>
        implements SchemaAssertionProperty<T> {

    public AbstractStringAssertion(SpecVersion specVersion, T value) throws SchemaPropertyNotExistsInSpecificationException {
